...
<div id="body">
        <div class="containerr">
            <div id="content" class="full">
                <c:choose>
                    <c:when test="${sizeOrderList!=0}">
                <div class="cart-table">
                    <table style="margin: 0 auto;">
                        <tr>
                            <th class="numberOrder">№</th>
                            <th class="itemsNew">Товар</th>
                            <th class="price">Цена</th>
                            <th class="price">Сумма заказа со скидкой</th>
                            <th class="total">Статус</th>
                            <th class="delete"></th>
                        </tr>
                        <form action="${pageContext.request.contextPath}/ordersUserDelete" method="post" class="frm">
                        <c:forEach items="${listOrder}" var="orderEl" varStatus="i">
                            <tr>
                                <td scope="row" class="numberOrder">${i.count}</td>
                                <td class="items">
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${orderEl.status=='ожидание'}">
                                                <button type="submit" class="btn btn-inverse" value="${i.count}" name="delete">Удалить</button>
                                            </c:when>
                                            <c:otherwise>
                                                <button type="submit" class="btn btn-inverse" disabled>Delete</button>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                            </tr>
...
<script src="${pageContext.request.contextPath}/kursach_shop/web/resources/js/plugins.js"></script>
<script src="${pageContext.request.contextPath}/kursach_shop/web/resources/js/main.js"></script>
